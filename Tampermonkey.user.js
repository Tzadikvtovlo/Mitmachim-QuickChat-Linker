...
// @version      3.0
// @description  הזרקת לחצן צ'אט מהיר ליד כל פוסט בפורום מתמחים.טופ והדבקת קישור הפוסט אוטומטית, הזרקת כפתורי העתקת קישור וקריאה בהמשך, והוספת רשימת קריאה בסרגל הצד
